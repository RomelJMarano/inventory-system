        ...
        <form id="addEquipmentForm">
          <div class="col">
            <div class="form-group">
              ...
              <input type="text" id="itemName" name="item_name" placeholder="Enter item name" required><br>
            </div>
            <div class="form-group">
          ...
          <div class="col">
            ...
            <div class="form-group">
              ...
              <input type="number" id="quantity" name="item_quantity" placeholder="Enter quantity" required> 
            </div>
          </div>
          <div class="row">
